...
const initialVectors: SteeringVector[] = [
  ...
  },
  {
    ...
    blurb: "Steer toward supportive tone (away from demoralizing phrasing).",
    enabled: false,
    level: 0,
    category: "behavior",
    icon: Smile,
  ...
  {
    id: "stereotypes",
    actionTitle: "Reduce stereotyping",
    blurb: "Steer away from unfair group assumptions.",
    enabled: false,
    level: 0,
    category: "behavior",
    icon: Scale,
  ...
  {
    id: "legal_compliance",
    actionTitle: "Boost legal & policy safety",
    blurb: "Steer away from risky legal/medical/financial advice toward safer disclaimers.",
    enabled: false,
    level: 0,
    category: "behavior",
    icon: CheckSquare,
